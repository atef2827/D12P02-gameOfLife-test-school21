/* The Game of Life -- Conway's cellular automaton (ncurses real-time version).
 *
 * This is the alternative build. It auto-evolves on a timer and reads live key
 * presses, giving smooth animation. See game_of_life.c for the dependency-free
 * <stdio.h>-only build.
 *
